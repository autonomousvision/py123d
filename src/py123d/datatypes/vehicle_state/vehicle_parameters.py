...
def imu_se3_to_rear_axle_se3(imu_se3: PoseSE3, vehicle_parameters: VehicleParameters) -> PoseSE3:
...
def rear_axle_se3_to_imu_se3(rear_axle_se3: PoseSE3, vehicle_parameters: VehicleParameters) -> PoseSE3:
...
def imu_se2_to_rear_axle_se2(imu_se2: PoseSE2, vehicle_parameters: VehicleParameters) -> PoseSE2:
...
def rear_axle_se2_to_imu_se2(rear_axle_se2: PoseSE2, vehicle_parameters: VehicleParameters) -> PoseSE2:
...
def imu_se3_to_center_se3(imu_se3: PoseSE3, vehicle_parameters: VehicleParameters) -> PoseSE3:
...
def center_se3_to_imu_se3(center_se3: PoseSE3, vehicle_parameters: VehicleParameters) -> PoseSE3:
...
def imu_se2_to_center_se2(imu_se2: PoseSE2, vehicle_parameters: VehicleParameters) -> PoseSE2:
...
def center_se2_to_imu_se2(center_se2: PoseSE2, vehicle_parameters: VehicleParameters) -> PoseSE2:
