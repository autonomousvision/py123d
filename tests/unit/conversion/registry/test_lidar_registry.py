...
class TestLiDARRegistry(unittest.TestCase):
    ...
    def test_initialize_all_types(self):
        ...
        for lidar_enum_class in LIDAR_INDEX_REGISTRY.values():
            ...
            for integer in range(len(lidar_enum_class)):
                ...
                self.assertIsInstance(lidar_pc_index, LiDARIndex)
                self.assertIsInstance(lidar_pc_index, IntEnum)
                self.assertIsInstance(lidar_pc_index, int)
    ...
    def test_xy_slice(self):
        ...
        for lidar_enum_class in LIDAR_INDEX_REGISTRY.values():
            ...
            self.assertEqual(lidar_pc_xy_slice.shape[-1], 2)
    ...
    def test_xyz_slice(self):
        ...
        for lidar_enum_class in LIDAR_INDEX_REGISTRY.values():
            ...
            self.assertEqual(lidar_pc_xyz_slice.shape[-1], 3)
