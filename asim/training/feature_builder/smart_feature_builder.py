...
from asim.common.geometry.transform.se2_array import convert_absolute_to_relative_se2_array
from asim.common.visualization.color.default import TrafficLightStatus
...
def _build_agent_features(scene: AbstractScene, origin: StateSE2) -> None:
    ...
    for box_detections in box_detections_list:
        in_types, _ = _filter_agents_by_type(box_detections, target_types)
