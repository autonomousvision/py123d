...
# from asim.training.models.sim_agent.smart.utils.finetune import set_model_for_finetuning

# from src.utils.vis_waymo import VisWaymo
# from src.utils.wosac_utils import get_scenario_id_int_tensor, get_scenario_rollouts


class SMARTForecasting(LightningModule):
    def __init__(self, model_config: SMARTForecastingConfig) -> None:
        super(SMARTForecasting, self).__init__()
