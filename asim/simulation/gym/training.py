...
from asim.simulation.gym.policy.ppo.ppo_config import GlobalConfig
from asim.simulation.gym.policy.ppo.ppo_model import PPOPolicy
...
def run_training(cfg: DictConfig) -> None:
    ...
    register(
        ...
        entry_point="asim.simulation.gym.environment.environment_wrapper:EnvironmentWrapper",
