...
class AbstractGymObservation(ABC):
    ...
    def get_gym_observation(
        ...
        :param planner_input: Planner input as defined in the d123 interface.
        :param planner_initialization: Planner initialization as defined in the d123 interface.
